...
function sendComment(){
    start_spin('contact-form-container');
    name = $('#contact-form-container #name').val();
    email = $('#contact-form-container #email').val();
    phone = $('#contact-form-container #phone').val();
    description = $('#contact-form-container #description').val();
    $('#send_email #name').val(name);
    $('#send_email #email').val(name);
    $('#send_email #phone').val(name);
    $('#send_email #description').val(name);
    $('#send_email').trigger('submit.rails');
}
